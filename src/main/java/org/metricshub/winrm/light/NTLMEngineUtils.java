...
public class NTLMEngineUtils {
	...
	/** Strip everything from the first dot onward (FQDN host/domain -> short name). */
	static String stripDotSuffix(final String value) {
		if (value == null) {
			return null;
		}
	...
	/** Convert a host name to its unqualified (short) form. */
	static String convertHost(final String host) {
		return stripDotSuffix(host);
	}

	/** Convert a domain name to its unqualified (short) form. */
	 ...
	 */
	static Charset getCharset(final int flags) throws NtlmException {
