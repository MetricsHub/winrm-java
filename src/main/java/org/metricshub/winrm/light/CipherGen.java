...
public class CipherGen {
	...
	private byte[] getLMHash() throws NtlmException {
		if (lmHash == null) {
	...
	private byte[] getNTLMHash() throws NtlmException {
		if (ntlmHash == null) {
	...
	private byte[] getLMv2Hash() throws NtlmException {
		if (lmv2Hash == null) {
	...
	private byte[] getNTLMv2Hash() throws NtlmException {
		if (ntlmv2Hash == null) {
	...
	private static byte[] ntlm2SessionResponse(
		...
		} catch (final NtlmException e) {
			throw (NtlmException) e;
